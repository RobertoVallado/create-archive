...
RUN pip install --no-cache-dir mkdocs mkdocs-material mkdocs-mermaid2-plugin watchdog mkdocs-macros-plugin mkdocs-rss-plugin pymdown-extensions mkdocs-static-i18n
